...
export const SidebarNew = ({ isOpen }: SidebarProps) => {
  ...
  // Simulando planos - isso deveria vir de uma API/contexto real
  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Comunicação', icon: MessageCircle, path: '/comunicacao', minPlan: 'enterprise' as UserPlan },
      ]
    },
    {
      id: 'management',
          ...
          <CardContent className="p-3">
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div className="flex flex-col">
                  <span className="text-blue-700">Contatos</span>
